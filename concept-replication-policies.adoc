...
summary: Möglicherweise benötigen Sie Hilfe bei der Auswahl einer Replikationsrichtlinie, wenn Sie die Datenreplikation in der NetApp Console einrichten.  Eine Replikationsrichtlinie definiert, wie das Speichersystem Daten von einem Quellvolume auf ein Zielvolume repliziert. 
---
