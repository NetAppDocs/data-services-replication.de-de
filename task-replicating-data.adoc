...
summary: Sie können Daten zwischen ONTAP-Systemen replizieren, indem Sie entweder eine einmalige Datenreplizierung für den Datentransfer oder einen wiederkehrenden Zeitplan für die Notfallwiederherstellung oder die langfristige Aufbewahrung auswählen. Beispielsweise lässt sich eine Datenreplizierung von einem lokalen ONTAP-System zu Cloud Volumes ONTAP für die Notfallwiederherstellung einrichten. 
---
...
Bevor Daten repliziert werden können, sollte bestätigt werden, dass die spezifischen Anforderungen für Cloud Volumes ONTAP, lokale ONTAP Cluster oder Amazon FSx für ONTAP erfüllt sind.
...
+
--
* https://docs.netapp.com/us-en/storage-management-fsx-ontap/start/task-getting-started-fsx.html["Erstellen Sie ein Amazon FSx für ONTAP -System"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-overview-cvo.html["Erstellen Sie ein Cloud Volumes ONTAP -System"^]
...
* https://docs.netapp.com/us-en/storage-management-ontap-onprem/task-discovering-ontap.html["Entdecken Sie ONTAP Cluster"^]
...
* Wenn ein lokaler ONTAP Cluster Teil der Beziehung ist, muss die Konnektivität zwischen dem lokalen Netzwerk und der AWS VPC über eine Direct Connect oder VPN Verbindung bestehen.
...
+
Die verbleibenden Schritte liefern ein Beispiel dafür, wie eine Sync-Beziehung zwischen Cloud Volumes ONTAP oder On-Premises ONTAP Clustern erstellt wird.
