...
summary: Bevor Sie einen Supportfall beim technischen Support von NetApp eröffnen können, müssen Sie BlueXP ein NetApp Support Site-Konto hinzufügen und sich dann für den Support registrieren. 
---
